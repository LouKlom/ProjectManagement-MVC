...
<?php if ($project): ?>
    ...
    <h2>Tasks</h2>
    <p><a href="/public/index.php?route=tasks&action=create&project_id=<?= $project['id']; ?>">Créer une nouvelle tâche</a></p>
    ...
    <p><a href="/public/index.php?route=projects&action=edit&id=<?= $project['id']; ?>">Edit this project</a></p>
    <p><a href="/public/index.php?route=projects&action=list">Back to Project List</a></p>
<?php else: ?>
